...
var require_xml_hint = __commonJS({
  "node_modules/codemirror/addon/hint/xml-hint.js"(exports, module) {
    (function(mod) {
      ...
      CodeMirror2.registerHelper("hint", "xml", getHints);
    });
  }
});

// node_modules/codemirror/addon/hint/html-hint.js
var require_html_hint = __commonJS({
  "node_modules/codemirror/addon/hint/html-hint.js"(exports, module) {
    (function(mod) {
      if (typeof exports == "object" && typeof module == "object")
        mod(require_codemirror(), require_xml_hint());
      else if (typeof define == "function" && define.amd)
      ...
      for (var tag in data)
        if (data.hasOwnProperty(tag) && data[tag] != s)
          populate(data[tag]);
      CodeMirror2.htmlSchema = data;
      function htmlHint(cm, options) {
        var local = { schemaInfo: data };
        if (options)
          for (var opt in options)
            local[opt] = options[opt];
        return CodeMirror2.hint.xml(cm, local);
      }
      CodeMirror2.registerHelper("hint", "html", htmlHint);
    });
  }
});
export default require_html_hint();
//# sourceMappingURL=codemirror_addon_hint_html-hint.js.map
